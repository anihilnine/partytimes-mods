...
--LOG("HUSAR: " .. "Loading string extensions module: stringX.LUA... "  )
...
function initalize()
    ...
    locals['game_quality'] = 'Game Quality'
    locals['game_quality_info'] = 'Game quality based on rating of players in teams \n >90% - fair balance \n <90% - poor balance \n   --% - no data'
    ...
    locals['game_ranked_ladder'] = 'This is FAF ladder game'
    locals['game_ranked_info'] = 'Game is ranked if the these conditions are met:'  
    ...
    locals['game_ranked_HasLockedTeams'] = ' locked team'   
    ...
    locals['ratio.killsToBuilt_info'] = 'Sort players by their kills-to-built ratio that is calculated using total cost of units killed by total cost of units built. ' ..
        'This ratio tells how much player is killing vs. how much spending on units and eco upgrades' ..
        '\n Ratio > 0.25 (Pro) ' .. 
        '\n Ratio ~ 0.15 (Average) ' .. 
        '\n Ratio < 0.05 (Bad)'
    ...
    locals['ratio.killsToLoses_info'] = 'Sort players by their kills-to-loses ratio that is calculated using total cost of units killed by total cost of units lost. ' ..
        'This ratio tells how much player is aggressive and how well is using his units to kill enemy units' ..
        '\n Ratio > 2.0 (Pro) ' .. 
        '\n Ratio ~ 1.0 (Average) ' .. 
        '\n Ratio < 0.5 (Bad)'
    ...
    locals['eco.massTotal_info'] = 'Sort players and teams by their total mass collected. This column includes mass reclaimed and mass produced by mexes'
    locals['eco.massReclaim'] = 'Total Mass Reclaimed'
    locals['eco.massReclaim_info'] = 'Sort players and teams by their total mass reclaim. \n\n NOTE: Pending FAF patch that will add reclaim values to score data'
    ...
    locals['units.air'] = 'Air Units Filter'
    locals['units.air_info'] = 'Filter on/off and sort players by their current count of land units. \n Fillter off - gray icon \n Fillter on - white icon  '
    locals['units.land'] = 'Land Units Filter'
    locals['units.land_info'] = 'Filter on/off and sort players by their current count of land units. \n Fillter off - gray icon \n Fillter on - white icon '
    locals['units.base'] = 'Structures Filter'
    locals['units.base_info'] = 'Filter on/off and sort players by their current count of base structures. \n Fillter off - gray icon \n Fillter on - white icon '
    locals['units.navy'] = 'Naval Units Filter'
    locals['units.navy_info'] = 'Filter on/off and sort players by their current count of naval units. \n Fillter off - gray icon \n Fillter on - white icon '
    -- Victory Conditions
    ...
    -- Share Unit Cap
    locals['suc_none']   = 'Sharing cap with no one' -- when a player dies'
    locals['suc_all']    = 'Sharing cap with all' -- when a player dies'
    locals['suc_allies'] = 'Sharing cap with allies' -- when a player dies'
    -- Share Conditions
...
function tooltip(key)
    return { text = loc(key), body = loc(key..'_info') }
end 
