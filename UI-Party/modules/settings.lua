...
function init()
	...
	settingDescriptions = {
		...
		{ name = "Analysis", settings = {
			...
			{ indent = 1, key="immersionAcuDamage", type="bool", default=true, name="Screen goes red when acu is damage", description="Show red damage effect when acu gets damaged" },
		}},
