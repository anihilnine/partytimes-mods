...
--LOG("HUSAR: " .. "Loading number extensions module: numberX.LUA... "  )
...
function init(value) return value or 0 end
-- safely subtract values that might be uninitialized  
function subt(a, b) return init(a) - init(b) end
function subt0(a, b) 
    local v = subt(a, b)
...
-- HUSAR: added formatting for very large and negative numbers, 
