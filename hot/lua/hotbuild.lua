...
local pathMod = '/mods/hot/'
local pathTex = pathMod .. 'textures/'

local buildingTab
local upgradeTab = import(pathMod .. 'lua/upgradetab.lua').upgradeTab
...
function getBuildingTab()
  local btSource = import(pathMod .. 'lua/buildingtab.lua').buildingTab
  local buildingTab = {}
...
function getKeyActions()
  ...
  for name, values in bt do
    ...
    local ukaModifier = ""
    local ukaAction   = "UI_Lua import('" .. pathMod .. "lua/hotbuild.lua').buildAction('" .. name .. "','" .. ukaModifier .. "')"
    ...
    ukaModifier = "SHIFT"
    ukaAction   = "UI_Lua import('" .. pathMod .. "lua/hotbuild.lua').buildAction('" .. name .. "','" .. ukaModifier .. "')"
