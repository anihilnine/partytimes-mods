...
function loadNotifications()
	allNotifications = notificationFileHelper.getNotificationsInDir(notificationScripts)
	allTimedNotifications = notificationFileHelper.getNotificationsInDir(notificationTimed)
...
function handleNotification(notification)
	...
	notification.icon = notificationFileHelper.getResource(notificationConfig.icon, iconpath)
