...
function SetLayout()
    ...
    --LOG('>>>> HUSAR: score_mini texture Bracket... ')
    ...
    --LOG('>>>> HUSAR: score_mini texture panel... ')
    ...
    -- NOTE move loading icons for timer and unit counter to score.LUA
    
    --LOG('>>>> HUSAR: score_mini texture time/tank... ')
    local x = 10
    ...
    --LOG('>>>> HUSAR: score_mini layout lines... ')
    LayoutArmyLines()
end
